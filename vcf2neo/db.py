...
def create_variant_site_nodes(record, known_sites, annotation, v_set=None, c_set=None):
    """
    ...
    if gene:
        ...
        graph.push(v_site)
    call = create_call_nodes(record, v_set, c_set, annotation)
...
def create_call_nodes(record, v_set, c_set, annotation):
    """
    Create Call Nodes
    :return:
    """
